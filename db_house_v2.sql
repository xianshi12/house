...
CREATE TABLE `property_comment`  (
  ...
  `avatar_url` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '头像',
...
CREATE TABLE `house_type`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `house_type` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '房屋类型',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `house_type`(`house_type` ASC) USING BTREE
...
-- ----------------------------
INSERT INTO `house_type` VALUES (1, '2025-12-20 13:49:21', '一居室');
INSERT INTO `house_type` VALUES (2, '2025-12-20 13:49:21', '二居室');
INSERT INTO `house_type` VALUES (3, '2025-12-20 13:49:21', '三居室');
INSERT INTO `house_type` VALUES (4, '2025-12-20 13:49:21', '复室');
INSERT INTO `house_type` VALUES (5, '2025-12-20 13:49:21', '公寓');
INSERT INTO `house_type` VALUES (6, '2025-12-20 13:49:21', '别墅');
INSERT INTO `house_type` VALUES (7, '2025-12-20 13:49:21', '简约风');
INSERT INTO `house_type` VALUES (8, '2025-12-20 13:49:21', '精装房');
...
CREATE TABLE `property_info`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `property_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '房屋名称',
  `house_type` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '房屋类型',
  `property_image` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '房屋图片',
  `floor` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '楼层',
  `rooms` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '厅室',
  `district` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '地段',
  `sale_price` int NOT NULL COMMENT '出售价格',
  `details` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '详情',
  `address` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '位置',
  `floor_area` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '面积',
  `developer_code` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '开发商号',
  `developer_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '开发商名',
  `sale_contract` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '出售合同',
  `contact_phone` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '联系电话',
...
-- ----------------------------
INSERT INTO `property_info` VALUES (1, '2025-12-20 13:49:21', '现代客厅·都市雅居', '一居室', 'upload/fangyuanxinxi_fangwutupian1.jpg,upload/fangyuanxinxi_fangwutupian2.jpg,upload/fangyuanxinxi_fangwutupian3.jpg', '低层/共6层', '1室1厅1卫', '市中心/商圈核心', 1, '<p>精装修一居室，现代简约风格，客厅宽敞明亮，配备智能家居系统，适合年轻都市精英居住。</p>', '北京市朝阳区建国路88号', '65平方米', '开发商号1', '开发商名1', '', '13823888881', '2025-12-20 13:49:21', 0, 1);
INSERT INTO `property_info` VALUES (2, '2025-12-20 13:49:21', '温馨主卧室·飘窗采光', '二居室', 'upload/fangyuanxinxi_fangwutupian2.jpg,upload/fangyuanxinxi_fangwutupian3.jpg,upload/fangyuanxinxi_fangwutupian4.jpg', '中层/共18层', '2室1厅1卫', '近地铁/交通便利', 2, '<p>温馨二居室，主卧带飘窗，采光极佳。小区绿化率高，周边配套成熟，交通便利。</p>', '上海市浦东新区世纪大道100号', '88平方米', '开发商号2', '开发商名2', '', '13823888882', '2025-12-20 13:49:21', 0, 2);
INSERT INTO `property_info` VALUES (3, '2025-12-20 13:49:21', '独栋别墅·庭院景观', '三居室', 'upload/fangyuanxinxi_fangwutupian3.jpg,upload/fangyuanxinxi_fangwutupian4.jpg,upload/fangyuanxinxi_fangwutupian5.jpg', '高层/共33层', '3室2厅2卫', '滨江/景观地段', 3, '<p>独栋别墅，带私家庭院和车库。三层设计，空间布局合理，花园景观优美，适合多代同堂。</p>', '杭州市西湖区杨公堤路22号', '145平方米', '开发商号3', '开发商名3', '', '13823888883', '2025-12-20 13:49:21', 0, 3);
INSERT INTO `property_info` VALUES (4, '2025-12-20 13:49:21', '一居开间·木地板', '复室', 'upload/fangyuanxinxi_fangwutupian4.jpg,upload/fangyuanxinxi_fangwutupian5.jpg,upload/fangyuanxinxi_fangwutupian6.jpg', '低层/共11层', '1室1厅1卫', '学区房/教育资源丰富', 4, '<p>紧凑型一居开间，实木地板铺设，厨卫齐全。位于城市核心区域，生活配套完善。</p>', '深圳市南山区科技园南区', '42平方米', '开发商号4', '开发商名4', '', '13823888884', '2025-12-20 13:49:21', 0, 4);
INSERT INTO `property_info` VALUES (5, '2025-12-20 13:49:21', '简约次卧·书房一体', '公寓', 'upload/fangyuanxinxi_fangwutupian5.jpg,upload/fangyuanxinxi_fangwutupian6.jpg,upload/fangyuanxinxi_fangwutupian7.jpg', '中层/共26层', '2室2厅1卫', '新兴开发区/潜力地段', 5, '<p>简约二居室，次卧可兼做书房。全新装修，品牌家电，小区安保完善，物业管理优质。</p>', '成都市高新区天府大道999号', '95平方米', '开发商号5', '开发商名5', '', '13823888885', '2025-12-20 13:49:21', 0, 5);
INSERT INTO `property_info` VALUES (6, '2025-12-20 13:49:21', '舒适卧室·明快配色', '别墅', 'upload/fangyuanxinxi_fangwutupian6.jpg,upload/fangyuanxinxi_fangwutupian7.jpg,upload/fangyuanxinxi_fangwutupian8.jpg', '高层/共30层', '3室2厅2卫', '老城区/生活配套成熟', 6, '<p>舒适三居室，南北通透，明快配色。主卧套房设计，独立衣帽间，高层景观视野开阔。</p>', '广州市天河区珠江新城', '160平方米', '开发商号6', '开发商名6', '', '13823888886', '2025-12-20 13:49:21', 0, 6);
INSERT INTO `property_info` VALUES (7, '2025-12-20 13:49:21', '简约主卧·明窗净几', '简约风', 'upload/fangyuanxinxi_fangwutupian7.jpg,upload/fangyuanxinxi_fangwutupian8.jpg,upload/fangyuanxinxi_fangwutupian1.jpg', '低层/共7层', '1室1厅1卫', '近公园/环境宜人', 7, '<p>精致一居室，明窗净几，简约装修。低楼层但采光好，适合首次置业或投资出租。</p>', '南京市鼓楼区中山北路66号', '38平方米', '开发商号7', '开发商名7', '', '13823888887', '2025-12-20 13:49:21', 0, 8);
INSERT INTO `property_info` VALUES (8, '2025-12-20 13:49:21', '精装公寓·都市风尚', '精装房', 'upload/fangyuanxinxi_fangwutupian8.jpg,upload/fangyuanxinxi_fangwutupian1.jpg,upload/fangyuanxinxi_fangwutupian2.jpg', '中层/共20层', '2室2厅2卫', '科技园区/就业便利', 8, '<p>精装两居室，都市风尚设计，配备中央空调和地暖。社区配套齐全，临近地铁站。</p>', '武汉市洪山区珞喻路188号', '120平方米', '开发商号8', '开发商名8', '', '13823888888', '2025-12-20 13:49:21', 0, 8);
INSERT INTO `property_info` VALUES (9, '2025-12-20 13:49:21', '阿斯蒂芬', '精装房', 'upload/1744362387412.jpeg', '22楼', '2房2厅2卫', '上海普通', 2222222, '<p>编辑框可以添加图片和文本等。编辑框可以添加图片和文本等。编辑框可以添加图片和文本等。编辑框可以添加图片和文本等。编辑框可以添加图片和文本等。编辑框可以添加图片和文本等。编辑框可以添加图片和文本等。编辑框可以添加图片和文本等。编辑框可以添加图片和文本等。编辑框可以添加图片和文本等。编辑框可以添加图片和文本等。编辑框可以添加图片和文本等试测试测试测试测试测试测，试测试测试测试测试测试测，试测试测试测试测试测试测试。</p>', '上海浦东22号', '89平方', '22', '上海开发商', 'upload/1744362428522.zip', '13922222288', '2025-12-20 13:49:21', 0, 1);

-- ----------------------------
-- Table structure for hetongqianding
-- ----------------------------
DROP TABLE IF EXISTS `contract_signing`;
CREATE TABLE `contract_signing`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `order_no` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '订单编号',
  `property_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '房屋名称',
  `house_type` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '房屋类型',
  `property_image` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '房屋图片',
  `floor_area` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '面积',
  `rooms` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '厅室',
  `floor` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '楼层',
  `district` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '地段',
  `sale_price` int NULL DEFAULT NULL COMMENT '出售价格',
  `contact_phone` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '联系电话',
  `intent_deposit` double NOT NULL COMMENT '意向定金',
  `remaining_amount` double NOT NULL COMMENT '尾款金额',
  `developer_code` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '开发商号',
  `developer_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '开发商名',
  `account` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '账号',
  `full_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '姓名',
  `phone` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '手机',
  `id_card` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '身份证',
  `register_time` date NULL DEFAULT NULL COMMENT '登记时间',
  `contract` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '合同',
  `audit_status` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '待审核' COMMENT '是否审核',
  `audit_reply` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '审核回复',
  `is_paid` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '未支付' COMMENT '是否支付',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `contract_signing` VALUES (1, '2025-12-20 13:49:21', '订单编号1', '现代客厅·都市雅居', '一居室', 'upload/hetongqianding_fangwutupian1.jpg,upload/hetongqianding_fangwutupian2.jpg,upload/hetongqianding_fangwutupian3.jpg', '65平方米', '1室1厅1卫', '低层/共6层', '市中心/商圈核心', 1, '联系电话1', 1, 1, '开发商号1', '开发商名1', '账号1', '姓名1', '13823888881', '440300199101010001', '2025-12-20', '', '是', '', '未支付');
INSERT INTO `contract_signing` VALUES (2, '2025-12-20 13:49:21', '订单编号2', '温馨主卧室·飘窗采光', '二居室', 'upload/hetongqianding_fangwutupian2.jpg,upload/hetongqianding_fangwutupian3.jpg,upload/hetongqianding_fangwutupian4.jpg', '88平方米', '2室1厅1卫', '中层/共18层', '近地铁/交通便利', 2, '联系电话2', 2, 2, '开发商号2', '开发商名2', '账号2', '姓名2', '13823888882', '440300199202020002', '2025-12-20', '', '是', '', '未支付');
INSERT INTO `contract_signing` VALUES (3, '2025-12-20 13:49:21', '订单编号3', '独栋别墅·庭院景观', '三居室', 'upload/hetongqianding_fangwutupian3.jpg,upload/hetongqianding_fangwutupian4.jpg,upload/hetongqianding_fangwutupian5.jpg', '145平方米', '3室2厅2卫', '高层/共33层', '滨江/景观地段', 3, '联系电话3', 3, 3, '开发商号3', '开发商名3', '账号3', '姓名3', '13823888883', '440300199303030003', '2025-12-20', '', '是', '', '未支付');
INSERT INTO `contract_signing` VALUES (4, '2025-12-20 13:49:21', '订单编号4', '一居开间·木地板', '复室', 'upload/hetongqianding_fangwutupian4.jpg,upload/hetongqianding_fangwutupian5.jpg,upload/hetongqianding_fangwutupian6.jpg', '42平方米', '1室1厅1卫', '低层/共11层', '学区房/教育资源丰富', 4, '联系电话4', 4, 4, '开发商号4', '开发商名4', '账号4', '姓名4', '13823888884', '440300199404040004', '2025-12-20', '', '是', '', '未支付');
INSERT INTO `contract_signing` VALUES (5, '2025-12-20 13:49:21', '订单编号5', '简约次卧·书房一体', '公寓', 'upload/hetongqianding_fangwutupian5.jpg,upload/hetongqianding_fangwutupian6.jpg,upload/hetongqianding_fangwutupian7.jpg', '95平方米', '2室2厅1卫', '中层/共26层', '新兴开发区/潜力地段', 5, '联系电话5', 5, 5, '开发商号5', '开发商名5', '账号5', '姓名5', '13823888885', '440300199505050005', '2025-12-20', '', '是', '', '未支付');
INSERT INTO `contract_signing` VALUES (6, '2025-12-20 13:49:21', '订单编号6', '舒适卧室·明快配色', '别墅', 'upload/hetongqianding_fangwutupian6.jpg,upload/hetongqianding_fangwutupian7.jpg,upload/hetongqianding_fangwutupian8.jpg', '160平方米', '3室2厅2卫', '高层/共30层', '老城区/生活配套成熟', 6, '联系电话6', 6, 6, '开发商号6', '开发商名6', '账号6', '姓名6', '13823888886', '440300199606060006', '2025-12-20', '', '是', '', '未支付');
INSERT INTO `contract_signing` VALUES (7, '2025-12-20 13:49:21', '订单编号7', '简约主卧·明窗净几', '简约风', 'upload/hetongqianding_fangwutupian7.jpg,upload/hetongqianding_fangwutupian8.jpg,upload/hetongqianding_fangwutupian1.jpg', '38平方米', '1室1厅1卫', '低层/共7层', '近公园/环境宜人', 7, '联系电话7', 7, 7, '开发商号7', '开发商名7', '账号7', '姓名7', '13823888887', '440300199707070007', '2025-12-20', '', '是', '', '未支付');
INSERT INTO `contract_signing` VALUES (8, '2025-12-20 13:49:21', '订单编号8', '精装公寓·都市风尚', '精装房', 'upload/hetongqianding_fangwutupian8.jpg,upload/hetongqianding_fangwutupian1.jpg,upload/hetongqianding_fangwutupian2.jpg', '120平方米', '2室2厅2卫', '中层/共20层', '科技园区/就业便利', 8, '联系电话8', 8, 8, '开发商号8', '开发商名8', '账号8', '姓名8', '13823888888', '440300199808080008', '2025-12-20', '', '是', '', '未支付');
INSERT INTO `contract_signing` VALUES (9, '2025-12-20 13:49:21', '1744362594564', '阿斯蒂芬', '精装房', 'upload/1744362387412.jpeg', '89平方', '2房2厅2卫', '22楼', '上海普通', 2222222, '13922222289', 222222.2, 1999999.8, '22', '上海开发商', '11', '张三', '13922222222', '412345678912345221', '2025-12-20', 'upload/1744362639863.zip', '是', '阿斯蒂芬', '已支付');
...
CREATE TABLE `developer`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `developer_code` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '开发商号',
  `password` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '密码',
  `developer_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '开发商名',
  `gender` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '性别',
  `contact_phone` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '联系电话',
  `avatar` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '头像',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `developer_code`(`developer_code` ASC) USING BTREE
...
-- ----------------------------
INSERT INTO `developer` VALUES (21, '2025-12-20 13:49:21', '开发商号1', '123456', '开发商名1', '男', '13823888881', 'upload/kaifashang_touxiang1.jpg');
INSERT INTO `developer` VALUES (22, '2025-12-20 13:49:21', '开发商号2', '123456', '开发商名2', '男', '13823888882', 'upload/kaifashang_touxiang2.jpg');
INSERT INTO `developer` VALUES (23, '2025-12-20 13:49:21', '开发商号3', '123456', '开发商名3', '男', '13823888883', 'upload/kaifashang_touxiang3.jpg');
INSERT INTO `developer` VALUES (24, '2025-12-20 13:49:21', '开发商号4', '123456', '开发商名4', '男', '13823888884', 'upload/kaifashang_touxiang4.jpg');
INSERT INTO `developer` VALUES (25, '2025-12-20 13:49:21', '开发商号5', '123456', '开发商名5', '男', '13823888885', 'upload/kaifashang_touxiang5.jpg');
INSERT INTO `developer` VALUES (26, '2025-12-20 13:49:21', '开发商号6', '123456', '开发商名6', '男', '13823888886', 'upload/kaifashang_touxiang6.jpg');
INSERT INTO `developer` VALUES (27, '2025-12-20 13:49:21', '开发商号7', '123456', '开发商名7', '男', '13823888887', 'upload/kaifashang_touxiang7.jpg');
INSERT INTO `developer` VALUES (28, '2025-12-20 13:49:21', '开发商号8', '123456', '开发商名8', '男', '13823888888', 'upload/kaifashang_touxiang8.jpg');
INSERT INTO `developer` VALUES (1744362367858, '2025-12-20 13:49:21', '22', '22', '上海开发商', '男', '13922222289', 'upload/1744362367125.jpeg');
...
CREATE TABLE `viewing_reservation`  (
  ...
  `floor_area` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '面积',
  `contact_phone` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '联系电话',
  `address` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '位置',
  `developer_code` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '开发商号',
  `developer_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '开发商名',
  `appointment_time` datetime NOT NULL COMMENT '预约时间',
  `account` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '账号',
  `full_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '姓名',
  `phone` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '手机',
  `register_time` date NULL DEFAULT NULL COMMENT '登记时间',
  `audit_status` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '待审核' COMMENT '是否审核',
  `audit_reply` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '审核回复',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `viewing_reservation` VALUES (1, '2025-12-20 13:49:21', '现代客厅·都市雅居', '一居室', 'upload/kanfangyuyue_fangwutupian1.jpg,upload/kanfangyuyue_fangwutupian2.jpg,upload/kanfangyuyue_fangwutupian3.jpg', 1, '65平方米', '联系电话1', '北京市朝阳区建国路88号', '开发商号1', '开发商名1', '2025-12-20 13:49:21', '账号1', '姓名1', '13823888881', '2025-12-20', '是', '');
INSERT INTO `viewing_reservation` VALUES (2, '2025-12-20 13:49:21', '温馨主卧室·飘窗采光', '二居室', 'upload/kanfangyuyue_fangwutupian2.jpg,upload/kanfangyuyue_fangwutupian3.jpg,upload/kanfangyuyue_fangwutupian4.jpg', 2, '88平方米', '联系电话2', '上海市浦东新区世纪大道100号', '开发商号2', '开发商名2', '2025-12-20 13:49:21', '账号2', '姓名2', '13823888882', '2025-12-20', '是', '');
INSERT INTO `viewing_reservation` VALUES (3, '2025-12-20 13:49:21', '独栋别墅·庭院景观', '三居室', 'upload/kanfangyuyue_fangwutupian3.jpg,upload/kanfangyuyue_fangwutupian4.jpg,upload/kanfangyuyue_fangwutupian5.jpg', 3, '145平方米', '联系电话3', '杭州市西湖区杨公堤路22号', '开发商号3', '开发商名3', '2025-12-20 13:49:21', '账号3', '姓名3', '13823888883', '2025-12-20', '是', '');
INSERT INTO `viewing_reservation` VALUES (4, '2025-12-20 13:49:21', '一居开间·木地板', '复室', 'upload/kanfangyuyue_fangwutupian4.jpg,upload/kanfangyuyue_fangwutupian5.jpg,upload/kanfangyuyue_fangwutupian6.jpg', 4, '42平方米', '联系电话4', '深圳市南山区科技园南区', '开发商号4', '开发商名4', '2025-12-20 13:49:21', '账号4', '姓名4', '13823888884', '2025-12-20', '是', '');
INSERT INTO `viewing_reservation` VALUES (5, '2025-12-20 13:49:21', '简约次卧·书房一体', '公寓', 'upload/kanfangyuyue_fangwutupian5.jpg,upload/kanfangyuyue_fangwutupian6.jpg,upload/kanfangyuyue_fangwutupian7.jpg', 5, '95平方米', '联系电话5', '成都市高新区天府大道999号', '开发商号5', '开发商名5', '2025-12-20 13:49:21', '账号5', '姓名5', '13823888885', '2025-12-20', '是', '');
INSERT INTO `viewing_reservation` VALUES (6, '2025-12-20 13:49:21', '舒适卧室·明快配色', '别墅', 'upload/kanfangyuyue_fangwutupian6.jpg,upload/kanfangyuyue_fangwutupian7.jpg,upload/kanfangyuyue_fangwutupian8.jpg', 6, '160平方米', '联系电话6', '广州市天河区珠江新城', '开发商号6', '开发商名6', '2025-12-20 13:49:21', '账号6', '姓名6', '13823888886', '2025-12-20', '是', '');
INSERT INTO `viewing_reservation` VALUES (7, '2025-12-20 13:49:21', '简约主卧·明窗净几', '简约风', 'upload/kanfangyuyue_fangwutupian7.jpg,upload/kanfangyuyue_fangwutupian8.jpg,upload/kanfangyuyue_fangwutupian1.jpg', 7, '38平方米', '联系电话7', '南京市鼓楼区中山北路66号', '开发商号7', '开发商名7', '2025-12-20 13:49:21', '账号7', '姓名7', '13823888887', '2025-12-20', '是', '');
INSERT INTO `viewing_reservation` VALUES (8, '2025-12-20 13:49:21', '精装公寓·都市风尚', '精装房', 'upload/kanfangyuyue_fangwutupian8.jpg,upload/kanfangyuyue_fangwutupian1.jpg,upload/kanfangyuyue_fangwutupian2.jpg', 8, '120平方米', '联系电话8', '武汉市洪山区珞喻路188号', '开发商号8', '开发商名8', '2025-12-20 13:49:21', '账号8', '姓名8', '13823888888', '2025-12-20', '是', '');
INSERT INTO `viewing_reservation` VALUES (9, '2025-12-20 13:49:21', '阿斯蒂芬', '精装房', 'upload/1744362387412.jpeg', 2222222, '89平方', '13922222288', '上海浦东22号', '22', '上海开发商', '2025-12-20 13:49:21', '11', '张三', '13922222222', '2025-12-20', '是', '阿斯蒂芬');
...
CREATE TABLE `news`  (
  ...
  CONSTRAINT `news_ibfk_1` FOREIGN KEY (`typename`) REFERENCES `news_type` (`typename`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `news_type`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `news_type_980p`(`typename` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '售房资讯分类' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of newstype
-- ----------------------------
INSERT INTO `news_type` VALUES (1, '2025-12-20 13:49:21', '市场动态');
INSERT INTO `news_type` VALUES (2, '2025-12-20 13:49:21', '政策解读');
INSERT INTO `news_type` VALUES (3, '2025-12-20 13:49:21', '时代策略');
INSERT INTO `news_type` VALUES (4, '2025-12-20 13:49:21', '购房指南');
INSERT INTO `news_type` VALUES (5, '2025-12-20 13:49:21', '行业观察');
INSERT INTO `news_type` VALUES (6, '2025-12-20 13:49:21', '家居设计');
INSERT INTO `news_type` VALUES (7, '2025-12-20 13:49:21', '投资分析');
INSERT INTO `news_type` VALUES (8, '2025-12-20 13:49:21', '区域热点');
...
-- Records of storeup
-- ----------------------------
INSERT INTO `storeup` VALUES (1, '2025-12-20 13:49:21', 1744362307504, 7, 'property_info', '简约主卧·明窗净几', 'upload/fangyuanxinxi_fangwutupian7.jpg', '1', NULL, NULL);
...
INSERT INTO `storeup` VALUES (4, '2025-12-20 13:49:21', 1744362307504, 9, 'property_info', '阿斯蒂芬', 'upload/1744362387412.jpeg', '1', NULL, NULL);
...
-- Records of token
-- ----------------------------
INSERT INTO `token` VALUES (1, 1744362307504, '11', 'user', '用户', 'll8nyt9hk34tqxoodaeeyqnhw5jm7nbn', '2025-12-20 13:49:21', '2025-12-20 13:49:21');
INSERT INTO `token` VALUES (2, 1744362367858, '22', 'developer', '开发商', '79ry15zgwyblrzv4mm5823e8ksd51m95', '2025-12-20 13:49:21', '2025-12-20 13:49:21');
...
-- ----------------------------
DROP TABLE IF EXISTS `intent_deposit_payment`;
CREATE TABLE `intent_deposit_payment`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `order_no` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '订单编号',
  `property_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '房屋名称',
  `house_type` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '房屋类型',
  `property_image` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '房屋图片',
  `floor` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '楼层',
  `sale_price` int NULL DEFAULT NULL COMMENT '出售价格',
  `intent_deposit_ratio` double NULL DEFAULT NULL COMMENT '意向金占比',
  `intent_deposit` double NULL DEFAULT NULL COMMENT '意向定金',
  `floor_area` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '面积',
  `rooms` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '厅室',
  `district` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '地段',
  `address` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '位置',
...
-- ----------------------------
INSERT INTO `intent_deposit_payment` VALUES (1, '2025-12-20 13:49:21', '1111111111', '现代客厅·都市雅居', '一居室', 'upload/yixiangjinzhifu_fangwutupian1.jpg,upload/yixiangjinzhifu_fangwutupian2.jpg,upload/yixiangjinzhifu_fangwutupian3.jpg', '低层/共6层', 1, 1, 1, '65平方米', '1室1厅1卫', '市中心/商圈核心', '北京市朝阳区建国路88号', '开发商号1', '开发商名1', '账号1', '姓名1', '13823888881', '2025-12-20 13:49:21', '未支付');
INSERT INTO `intent_deposit_payment` VALUES (2, '2025-12-20 13:49:21', '2222222222', '温馨主卧室·飘窗采光', '二居室', 'upload/yixiangjinzhifu_fangwutupian2.jpg,upload/yixiangjinzhifu_fangwutupian3.jpg,upload/yixiangjinzhifu_fangwutupian4.jpg', '中层/共18层', 2, 2, 2, '88平方米', '2室1厅1卫', '近地铁/交通便利', '上海市浦东新区世纪大道100号', '开发商号2', '开发商名2', '账号2', '姓名2', '13823888882', '2025-12-20 13:49:21', '未支付');
INSERT INTO `intent_deposit_payment` VALUES (3, '2025-12-20 13:49:21', '3333333333', '独栋别墅·庭院景观', '三居室', 'upload/yixiangjinzhifu_fangwutupian3.jpg,upload/yixiangjinzhifu_fangwutupian4.jpg,upload/yixiangjinzhifu_fangwutupian5.jpg', '高层/共33层', 3, 3, 3, '145平方米', '3室2厅2卫', '滨江/景观地段', '杭州市西湖区杨公堤路22号', '开发商号3', '开发商名3', '账号3', '姓名3', '13823888883', '2025-12-20 13:49:21', '未支付');
INSERT INTO `intent_deposit_payment` VALUES (4, '2025-12-20 13:49:21', '4444444444', '一居开间·木地板', '复室', 'upload/yixiangjinzhifu_fangwutupian4.jpg,upload/yixiangjinzhifu_fangwutupian5.jpg,upload/yixiangjinzhifu_fangwutupian6.jpg', '低层/共11层', 4, 4, 4, '42平方米', '1室1厅1卫', '学区房/教育资源丰富', '深圳市南山区科技园南区', '开发商号4', '开发商名4', '账号4', '姓名4', '13823888884', '2025-12-20 13:49:21', '未支付');
INSERT INTO `intent_deposit_payment` VALUES (5, '2025-12-20 13:49:21', '5555555555', '简约次卧·书房一体', '公寓', 'upload/yixiangjinzhifu_fangwutupian5.jpg,upload/yixiangjinzhifu_fangwutupian6.jpg,upload/yixiangjinzhifu_fangwutupian7.jpg', '中层/共26层', 5, 5, 5, '95平方米', '2室2厅1卫', '新兴开发区/潜力地段', '成都市高新区天府大道999号', '开发商号5', '开发商名5', '账号5', '姓名5', '13823888885', '2025-12-20 13:49:21', '未支付');
INSERT INTO `intent_deposit_payment` VALUES (6, '2025-12-20 13:49:21', '6666666666', '舒适卧室·明快配色', '别墅', 'upload/yixiangjinzhifu_fangwutupian6.jpg,upload/yixiangjinzhifu_fangwutupian7.jpg,upload/yixiangjinzhifu_fangwutupian8.jpg', '高层/共30层', 6, 6, 6, '160平方米', '3室2厅2卫', '老城区/生活配套成熟', '广州市天河区珠江新城', '开发商号6', '开发商名6', '账号6', '姓名6', '13823888886', '2025-12-20 13:49:21', '未支付');
INSERT INTO `intent_deposit_payment` VALUES (7, '2025-12-20 13:49:21', '7777777777', '简约主卧·明窗净几', '简约风', 'upload/yixiangjinzhifu_fangwutupian7.jpg,upload/yixiangjinzhifu_fangwutupian8.jpg,upload/yixiangjinzhifu_fangwutupian1.jpg', '低层/共7层', 7, 7, 7, '38平方米', '1室1厅1卫', '近公园/环境宜人', '南京市鼓楼区中山北路66号', '开发商号7', '开发商名7', '账号7', '姓名7', '13823888887', '2025-12-20 13:49:21', '未支付');
INSERT INTO `intent_deposit_payment` VALUES (8, '2025-12-20 13:49:21', '8888888888', '精装公寓·都市风尚', '精装房', 'upload/yixiangjinzhifu_fangwutupian8.jpg,upload/yixiangjinzhifu_fangwutupian1.jpg,upload/yixiangjinzhifu_fangwutupian2.jpg', '中层/共20层', 8, 8, 8, '120平方米', '2室2厅2卫', '科技园区/就业便利', '武汉市洪山区珞喻路188号', '开发商号8', '开发商名8', '账号8', '姓名8', '13823888888', '2025-12-20 13:49:21', '未支付');
INSERT INTO `intent_deposit_payment` VALUES (9, '2025-12-20 13:49:21', '1744362594564', '阿斯蒂芬', '精装房', 'upload/1744362387412.jpeg', '22楼', 2222222, 0.1, 222222.2, '89平方', '2房2厅2卫', '上海普通', '上海浦东22号', '22', '上海开发商', '11', '张三', '13922222222', '2025-12-20 13:49:21', '已支付');
...
CREATE TABLE `user`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `account` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '账号',
  `password` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '密码',
  `full_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '姓名',
...
-- Records of yonghu
-- ----------------------------
INSERT INTO `user` VALUES (11, '2025-12-20 13:49:21', '账号1', '123456', '姓名1', '男', '13823888881', '440300199101010001', 'upload/yonghu_touxiang1.jpg');
INSERT INTO `user` VALUES (12, '2025-12-20 13:49:21', '账号2', '123456', '姓名2', '男', '13823888882', '440300199202020002', 'upload/yonghu_touxiang2.jpg');
INSERT INTO `user` VALUES (13, '2025-12-20 13:49:21', '账号3', '123456', '姓名3', '男', '13823888883', '440300199303030003', 'upload/yonghu_touxiang3.jpg');
INSERT INTO `user` VALUES (14, '2025-12-20 13:49:21', '账号4', '123456', '姓名4', '男', '13823888884', '440300199404040004', 'upload/yonghu_touxiang4.jpg');
INSERT INTO `user` VALUES (15, '2025-12-20 13:49:21', '账号5', '123456', '姓名5', '男', '13823888885', '440300199505050005', 'upload/yonghu_touxiang5.jpg');
INSERT INTO `user` VALUES (16, '2025-12-20 13:49:21', '账号6', '123456', '姓名6', '男', '13823888886', '440300199606060006', 'upload/yonghu_touxiang6.jpg');
INSERT INTO `user` VALUES (17, '2025-12-20 13:49:21', '账号7', '123456', '姓名7', '男', '13823888887', '440300199707070007', 'upload/yonghu_touxiang7.jpg');
INSERT INTO `user` VALUES (18, '2025-12-20 13:49:21', '账号8', '123456', '姓名8', '男', '13823888888', '440300199808080008', 'upload/yonghu_touxiang8.jpg');
INSERT INTO `user` VALUES (1744362307504, '2025-12-20 13:49:21', '11', '11', '张三', '女', '13922222222', '412345678912345221', 'upload/1744362306715.jpeg');
