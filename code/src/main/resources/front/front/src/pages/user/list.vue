	...
	<div>
		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<el-button class="list-add-btn" v-if="btnAuth('user','新增')" type="primary" @click="add('/index/yonghuAdd')">
					添加
				</el-button>
			</el-form>
			<div class="select2">
...
<script>
	export default {
		...
		async created() {
			...
			this.selectOptionsList.push({name:'性别',list:this.xingbieOptions,tableName: 'gender',check: -1})
