...
// 					// }
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other .el-menu .el-menu-item {
		...
		background: url(http://codegen.caihongy.cn/20240924/ac57f5bc21ed4f99a0d4ef2bcbd41bdd.png)  no-repeat  left top /  3% 100%,#fff !important;
		font-size: inherit !important;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other .el-menu .el-menu-item:hover {
		...
		margin: 0 0 0 10px !important;
		color: #A5A5A5 !important;
		background: url(http://codegen.caihongy.cn/20240924/a6fe2f32a7a94e09a35b0d95d813135a.png)  no-repeat  left top /  3% 100%,#fff !important;
		font-size: inherit !important;
		line-height: 40px !important;
		transition: all 0s !important;
		height: 40px !important;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.home .el-menu .el-menu-item {
		...
		margin: 0 0 0 10px;
		color: #A5A5A5;
		background: url(http://codegen.caihongy.cn/20240924/ac57f5bc21ed4f99a0d4ef2bcbd41bdd.png)  no-repeat  left top /  3% 100%,#fff;
		font-size: inherit;
		line-height: 40px;
		transition: all 0s;
		height: 40px;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.home .el-menu .el-menu-item:hover {
		...
		margin: 0 0 0 10px;
		color: #A5A5A5;
		background: url(http://codegen.caihongy.cn/20240924/a6fe2f32a7a94e09a35b0d95d813135a.png)  no-repeat  left top /  3% 100%,#fff;
		font-size: inherit;
		line-height: 40px;
		transition: all 0s;
		height: 40px;
