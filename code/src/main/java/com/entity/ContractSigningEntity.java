...
public class ContractSigningEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public ContractSigningEntity() {
		
	}
	
	public ContractSigningEntity(T t) {
		try {
	...
	public Double getWeikuanjine() { return remainingAmount; }
	public void setWeikuanjine(Double weikuanjine) { this.remainingAmount = weikuanjine; }
	...
	public String getHetong() { return contract; }
	public void setHetong(String hetong) { this.contract = hetong; }
	public String getYonghuhetong() { return userContract; }
	public void setYonghuhetong(String yonghuhetong) { this.userContract = yonghuhetong; }
