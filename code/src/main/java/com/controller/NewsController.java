...
@Autowired
    ...
    public R list(@RequestParam Map<String, Object> params,NewsEntity news, 
		HttpServletRequest request){
        // 尝试从Redis缓存获取
        String cacheKey = "news:list:" + params.hashCode();
        ...
        DeSensUtil.desensitize(page,deSens);
        // 缓存到Redis(1小时)
        redisUtils.set(cacheKey, page, 1, TimeUnit.HOURS);
        return R.ok().put("data", page);
    }
    ...
    public R query(NewsEntity news){
		...
		return R.ok("查询售房资讯成功").put("data", newsView);
    }
    ...
    public R delete(@RequestBody Long[] ids){
        ...
        // 清除缓存
        for(Long id : ids) {
            redisUtils.delete("news:detail:" + id);
        }
        return R.ok();
    }
